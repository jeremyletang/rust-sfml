...
pub const sfJoystickCount: _bindgen_ty_1 = 8;
pub const sfJoystickButtonCount: _bindgen_ty_1 = 32;
pub const sfJoystickAxisCount: _bindgen_ty_1 = 8;
...
pub type sfContextAttribute = u32;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
