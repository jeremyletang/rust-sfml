...
use csfml_system_sys::{sfBool, sfVector3f, sfTime, sfInt16, sfUint64, sfInputStream};

pub const sfStopped: u32 = 0;
pub const sfPaused: u32 = 1;
pub const sfPlaying: u32 = 2;

/* automatically generated by rust-bindgen
    EDIT 1: Replaced `size_t` by `usize`.
    EDIT 2: Replaced `sfSoundStatus` variants with named constants.
*/

#[derive(Copy, Clone)]
#[repr(u32)]
pub enum Enum_Unnamed1 { sfStopped = sfStopped, sfPaused = sfPaused, sfPlaying = sfPlaying, }
pub type sfSoundStatus = Enum_Unnamed1;
pub enum Struct_sfMusic { }
pub type sfMusic = Struct_sfMusic;
pub enum Struct_sfSound { }
pub type sfSound = Struct_sfSound;
pub enum Struct_sfSoundBuffer { }
pub type sfSoundBuffer = Struct_sfSoundBuffer;
pub enum Struct_sfSoundBufferRecorder { }
pub type sfSoundBufferRecorder = Struct_sfSoundBufferRecorder;
pub enum Struct_sfSoundRecorder { }
pub type sfSoundRecorder = Struct_sfSoundRecorder;
pub enum Struct_sfSoundStream { }
pub type sfSoundStream = Struct_sfSoundStream;
...
pub type sfSoundStreamChunk = Struct_Unnamed2;
