...
impl IntRect {
    ...
    pub unsafe fn from_raw(raw: ffi::sfIntRect) -> Self {
        Self {
            top: raw.top,
            left: raw.left,
            width: raw.width,
...
impl FloatRect {
    pub fn raw(&self) -> ffi::sfFloatRect {
        ffi::sfFloatRect {
            top: self.top,
            left: self.left,
            width: self.width,
    ...
    pub unsafe fn from_raw(raw: ffi::sfFloatRect) -> Self {
        Self {
            top: raw.top,
            left: raw.left,
            width: raw.width,
