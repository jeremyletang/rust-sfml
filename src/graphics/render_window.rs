...
impl RenderWindow {
    ...
    */
    pub fn set_mouse_position(&mut self, position : &vector2::Vector2i) -> () {
        unsafe {
    ...
    */
    pub fn draw<T : drawable::Drawable>(&mut self, object : &T) -> () {
    ...
    pub fn clear(&mut self, color : &color::Color) -> () {
        unsafe {
    ...
    * * view - The new view
    */
    pub fn set_view(&mut self, view : &view::View) -> () {
        unsafe {
