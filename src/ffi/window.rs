...
pub const sfEvtClosed: ::std::os::raw::c_int = 0;
pub const sfEvtResized: ::std::os::raw::c_int = 1;
pub const sfEvtLostFocus: ::std::os::raw::c_int = 2;
pub const sfEvtGainedFocus: ::std::os::raw::c_int = 3;
pub const sfEvtTextEntered: ::std::os::raw::c_int = 4;
pub const sfEvtKeyPressed: ::std::os::raw::c_int = 5;
pub const sfEvtKeyReleased: ::std::os::raw::c_int = 6;
pub const sfEvtMouseWheelScrolled: ::std::os::raw::c_int = 8;
pub const sfEvtMouseButtonPressed: ::std::os::raw::c_int = 9;
pub const sfEvtMouseButtonReleased: ::std::os::raw::c_int = 10;
pub const sfEvtMouseMoved: ::std::os::raw::c_int = 11;
pub const sfEvtMouseEntered: ::std::os::raw::c_int = 12;
pub const sfEvtMouseLeft: ::std::os::raw::c_int = 13;
pub const sfEvtJoystickButtonPressed: ::std::os::raw::c_int = 14;
pub const sfEvtJoystickButtonReleased: ::std::os::raw::c_int = 15;
pub const sfEvtJoystickMoved: ::std::os::raw::c_int = 16;
pub const sfEvtJoystickConnected: ::std::os::raw::c_int = 17;
pub const sfEvtJoystickDisconnected: ::std::os::raw::c_int = 18;
pub const sfEvtTouchBegan: ::std::os::raw::c_int = 19;
pub const sfEvtTouchMoved: ::std::os::raw::c_int = 20;
pub const sfEvtTouchEnded: ::std::os::raw::c_int = 21;
pub const sfEvtSensorChanged: ::std::os::raw::c_int = 22;
pub const sfEvtCount: ::std::os::raw::c_int = 23;
#[repr(C)]
#[derive(Debug, Copy, Clone, Hash, PartialOrd, Ord, PartialEq, Eq)]
