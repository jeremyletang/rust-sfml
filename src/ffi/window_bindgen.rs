...
// Cursor.cpp
pub fn sfCursor_createFromPixels(new_value: *mut sfCursor, pixels: *const u8, size: sfVector2u, hotspot: sfVector2u) -> bool;
pub fn sfCursor_createFromSystem(new_value: *mut sfCursor, type_: sfCursorType) -> bool;
