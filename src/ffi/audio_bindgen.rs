...
pub fn sfCustomSoundStream_new(onGetData: sfCustomSoundStreamGetDataCb, onSeek: sfCustomSoundStreamSeekCb, channelCount: c_uint, sampleRate: c_uint, channel: *const sfSoundChannelVector, userData: *mut c_void) -> *mut sfCustomSoundStream;
pub fn sfCustomSoundStream_del(soundStream: *mut sfCustomSoundStream);
...
pub fn sfSound_del(sound: *mut sfSound);
...
pub fn sfSoundBuffer_loadFromSamples(buffer: *mut sfSoundBuffer, samples: *const i16, sampleCount: u64, channelCount: c_uint, sampleRate: c_uint, channelMap: *const sfSoundChannelVector) -> bool;
