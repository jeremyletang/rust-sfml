...
pub use self::Event::{Closed, GainedFocus, JoystickButtonPressed, JoystickButtonReleased,
                      JoystickConnected, JoystickDisconnected, JoystickMoved, KeyPressed,
                      KeyReleased, LostFocus, MouseButtonPressed, MouseButtonReleased,
                      MouseEntered, MouseLeft, MouseMoved, MouseWheelMoved, NoEvent, Resized,
                      TextEntered};
