...
extern "C" {
    ...
    pub fn sfPacket_readFloat(packet: *mut sfPacket)
     -> ::std::os::raw::c_float;
    pub fn sfPacket_readDouble(packet: *mut sfPacket)
     -> ::std::os::raw::c_double;
    ...
    pub fn sfPacket_writeFloat(packet: *mut sfPacket,
                               arg1: ::std::os::raw::c_float);
    pub fn sfPacket_writeDouble(packet: *mut sfPacket,
